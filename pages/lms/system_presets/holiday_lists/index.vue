		...
		<client-only>
			<div id="sc-page-top-bar" class="sc-top-bar" data-uk-sticky="offset:48; show-on-up: true; animation: uk-animation-slide-top-medium">
				...
				<div class="sc-actions uk-margin-right uk-margin-small-top">
					<nuxt-link :to="'/lms/system_presets/holiday_lists/create'" class="sc-fab sc-fab-small sc-fab-text sc-fab-primary">
					...
					>
						...
						>
							<template slot-scope="props">
								<p>Holiday Name: {{ props.row.holiday_id }}</p>
								<p>Holiday Date: {{ props.row.holiday_date }}</p>
								<p>Holiday Type: {{ props.row.holiday_type }}</p>								
							</template>
						</el-table-column>
						<el-table-column prop="holiday_id" label="Holiday Name" sortable="custom">
						</el-table-column>
